// app/imports/ImportSuppliersScreen.tsx
...
export default function ImportSuppliersScreen() {
  ...
  const [duplicates, setDuplicates] = useState<DuplicateSupplier[]>([]);
    ...
    return (
      <View style={styles.screen}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Import Suppliers</Text>
          <View style={{ width: 60 }} />
        </View>
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      const example =
        "Acme Corp,John Smith,+1234567890,john@acme.com,456 Business Ave,Net 30,Preferred supplier\n" +
        "Global Goods,Jane Doe,+0987654321,jane@global.com,789 Trade St,COD,\n" +
        "Local Supplier,,+1122334455,,,Net 15,";
  ...
  const renderIdle = () => (
    <View style={styles.centerContent}>
      <View style={styles.uploadBox}>
        <Text style={styles.uploadIcon}>🏭</Text>
        <Text style={styles.uploadTitle}>Import Suppliers</Text>
        <Text style={styles.uploadSubtitle}>
          Upload a CSV file to bulk import suppliers into your records.
        </Text>
  ...
  const renderImporting = () => (
    <View style={styles.centerContent}>
      ...
      <Text style={styles.importingText}>
        Importing {rows.length} suppliers...
      </Text>
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalSubtitle}>
            {duplicates.length} supplier{duplicates.length > 1 ? "s" : ""}{" "}
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Alert.alert(
                ...
                `This will update ${duplicates.length} existing supplier${duplicates.length > 1 ? "s" : ""} with new data. This cannot be undone.`,
                [
